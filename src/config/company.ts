export const COMPANY = {
  ...
  founder: {
    ...
    photoPath: '/images/founder/vikash-studio-square.jpg',
    photoPathWebp: '/images/founder/vikash-studio-portrait.jpg',
    photoPathJpg: '/images/founder/vikash-studio-portrait.jpg',
