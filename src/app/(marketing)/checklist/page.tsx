      ...
      <section className="relative py-20 px-6 lg:px-8 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10 mb-16">
          ...
          <motion.h1
            ...
            className="uppercase text-3xl md:text-4xl lg:text-6xl font-black text-white mb-6 tracking-tight leading-tight"
          >
          ...
          >
            Don't launch your next project blind. Get the exact 50-point checklist we use to
            ensure our clients' websites are fast, secure, and ready to convert on day one.
          </motion.p>
        </div>
        ...
        <div className="max-w-xl mx-auto relative z-10">
          {sent ? (
            <motion.div
              ...
              className="text-center py-16 bg-[#12172b] rounded-3xl border border-white/10 shadow-2xl p-8 md:p-12"
            >
              ...
              <p className="text-zinc-400 mb-4">
                Check your inbox. We've sent the checklist PDF to <strong>{email}</strong>. The
                download link is delivered by email for security.
              </p>
              <p className="text-xs text-zinc-500">
                If you do not see it within a few minutes, check spam or contact support.
              </p>
            </motion.div>
          ) : (
            <motion.div
              ...
              animate={{ opacity: 1, scale: 1 }}
              className="bg-[#12172b] rounded-3xl border border-white/10 shadow-2xl p-8 md:p-12"
            >
              <div className="mb-8">
                ...
                <ul className="space-y-3">
                  {[
                    "Performance & SEO optimization checks",
                    "Security & data privacy requirements",
                    "Mobile responsiveness standards",
                    "Analytics & tracking setup steps",
                  ].map((item, i) => (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <p className="text-center text-xs text-zinc-500 mt-4">100% free. No spam, ever.</p>
              </form>
            </motion.div>
          )}
        </div>
