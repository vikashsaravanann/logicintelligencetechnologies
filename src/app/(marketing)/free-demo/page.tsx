    ...
    <main className="min-h-screen bg-[#0A0F1E] text-white pt-24">
      ...
      <section className="relative py-20 px-6 lg:px-8 overflow-hidden border-b border-white/5">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="uppercase text-3xl md:text-5xl lg:text-6xl font-black text-white mb-6 tracking-tight leading-[1.1]">
            SEE YOUR WEBSITE <br/>
