...
/** Circular brand mark — used by browsers as the site avatar in a circle. */
      ...
      >
        <div
          style={{
            ...
            border: "10px solid rgba(0, 191, 255, 0.35)",
            boxShadow: "0 0 40px rgba(0, 191, 255, 0.25)",
          }}
        >
          {/* Simplified circuit-brain mark (no wordmark — readable at 16–48px) */}
          <svg
            width="280"
            height="280"
            viewBox="0 0 120 120"
          ...
          >
            ...
            <circle cx="50" cy="72" r="3" fill="#7DD3FC" />
            <circle cx="70" cy="72" r="3" fill="#7DD3FC" />
          </svg>
        </div>
      </div>
    ),
