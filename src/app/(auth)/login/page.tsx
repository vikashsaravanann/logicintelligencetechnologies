  ...
  return (
    <main className="min-h-screen flex bg-white font-sans overflow-hidden">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 mb-6">
          <button
            type="button"
            onClick={() => handleOAuthLogin("google")}
            disabled={isLoading}
            className="flex items-center justify-center gap-2.5 min-h-11 py-2.5 rounded-xl text-[13px] font-semibold bg-white border border-[#dadce0] hover:shadow-md hover:bg-[#f8f9fa] transition-all text-[#3c4043] disabled:opacity-50"
          >
          ...
          <button
            ...
            disabled={isLoading}
            className="flex items-center justify-center gap-2.5 min-h-11 py-2.5 rounded-xl text-[13px] font-semibold bg-[#24292f] hover:bg-[#1b1f23] transition-all text-white disabled:opacity-50"
          >
          ...
          <button
            ...
            disabled={isLoading}
            className="flex items-center justify-center gap-2.5 min-h-11 py-2.5 rounded-xl text-[13px] font-semibold bg-black hover:bg-[#141414] transition-all text-white disabled:opacity-50"
          >
