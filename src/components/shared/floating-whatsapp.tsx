...
export default function FloatingWhatsApp() {
  return (
    <a
      ...
      className="fixed bottom-4 left-4 sm:bottom-6 sm:left-6 z-[60] w-11 h-11 sm:w-14 sm:h-14 rounded-full bg-[#25D366] text-white flex items-center justify-center shadow-lg shadow-[#25D366]/30 hover:scale-105 transition-transform cursor-pointer"
    >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="w-5 h-5 sm:w-8 sm:h-8 fill-current" aria-hidden>
